...
const addButton=document.querySelector("[data-admin-add]"),titleInput=form.querySelector("[name=title]"),slugInput=form.querySelector("[data-admin-slug]");
